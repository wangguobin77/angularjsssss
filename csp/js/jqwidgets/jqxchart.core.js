...
(function (a) {
    ...
    a.extend(a.jqx._jqxChart.prototype, {
        ...
        clear: function () {
            ...
            var o = this;
            var L = o.renderer;
            o._validateSeriesGroups();
            o._colorsCache.clear();
            if (!o._isToggleRefresh && o._isUpdate && o._renderData) {
                o._renderDataClone()
            }
            o._renderData = [];
            L.clear();
            ...
            if (p == undefined || p == "") {
                ...
                o.host.css({
                    "background-image": (p.indexOf("(") != -1 ? p : "url('" + p + "')")
                })
            }
            o._rect = F;
            var ad = o.padding || {
            ...
            var s = L.createClipRect(F);
            var O = L.beginGroup();
            L.setClip(O, s);
            var an = L.rect(F.x, F.y, F.width - 2, F.height - 2);
            if (p == undefined || p == "") {
                L.attr(an, {
                    fill: o.backgroundColor || o.background || "white"
                })
            } else {
                L.attr(an, {
                    fill: "transparent"
                })
            } if (o.showBorderLine != false) {
                var I = o.borderLineColor == undefined ? o.borderColor : o.borderLineColor;
                if (I == undefined) {
                    I = o._defaultLineColor
                }
                var q = this.borderLineWidth;
                if (isNaN(q) || q < 0 || q > 10) {
                    q = 1
                }
                L.attr(an, {
                ...
                if (a.jqx.browser.msie && a.jqx.browser.version < 9) {
                    L.attr(an, {
                        "stroke-width": 1,
                        stroke: o.backgroundColor || "white"
                    })
                }
            } if (a.isFunction(o.drawBefore)) {
                o.drawBefore(L, F)
            }
            var aa = {
                x: ad.left,
                y: ad.top,
                width: F.width - ad.left - ad.right,
                height: F.height - ad.top - ad.bottom
            };
            o._paddedRect = aa;
            var f = o.titlePadding || {
                left: 2,
                top: 2,
                right: 2,
                bottom: 2
            ...
            if (o.title && o.title.length > 0) {
                var W = o.toThemeProperty("jqx-chart-title-text", null);
                n = L.measureText(o.title, 0, {
                    "class": W
                });
                L.text(o.title, aa.x + f.left, aa.y + f.top, aa.width - (f.left + f.right), n.height, 0, {
                    "class": W
                }, true, "center", "center");
                aa.y += n.height;
                aa.height -= n.height
            ...
            if (o.description && o.description.length > 0) {
                var Y = o.toThemeProperty("jqx-chart-title-description", null);
                n = L.measureText(o.description, 0, {
                    "class": Y
                });
                L.text(o.description, aa.x + f.left, aa.y + f.top, aa.width - (f.left + f.right), n.height, 0, {
                    "class": Y
                }, true, "center", "center");
                aa.y += n.height;
                aa.height -= n.height
            ...
            o._plotRect = b;
            o._buildStats(b);
            var K = o._isPieOnlySeries();
            var v = o.seriesGroups;
            var H;
            var G = {
                xAxis: {},
                valueAxis: {}
            };
            for (var ae = 0; ae < v.length && !K; ae++) {
                if (v[ae].type == "pie" || v[ae].type == "donut") {
                    continue
                }
                var C = o._getXAxis(ae);
                if (!C) {
                    throw "seriesGroup[" + ae + "] is missing xAxis definition"
                }
                var aj = C == o._getXAxis() ? -1 : ae;
                G.xAxis[aj] = 0
            }
            var Z = o.axisPadding;
            if (isNaN(Z)) {
            ...
            for (ae = 0; ae < v.length; ae++) {
                var ai = v[ae];
                if (ai.type == "pie" || ai.type == "donut" || ai.spider == true || ai.polar == true) {
                    r.push({
                        width: 0,
                        position: 0,
                        xRel: 0
                ...
                H = ai.orientation == "horizontal";
                var C = o._getXAxis(ae);
                var aj = C == o._getXAxis() ? -1 : ae;
                var m = o._getValueAxis(ae);
                var R = m == o._getValueAxis() ? -1 : ae;
                var U = !H ? m.axisSize : C.axisSize;
                var k = {
                    x: 0,
                    y: b.y,
                    width: b.width,
                ...
                var T = H ? o._getXAxis(ae).position : m.position;
                if (!U || U == "auto") {
                    if (H) {
                        U = this._renderXAxis(ae, k, true, b).width;
                        if ((G.xAxis[aj] & 1) == 1) {
                            U = 0
                        } else {
                            if (U > 0) {
                        ...
                        U = o._renderValueAxis(ae, k, true, b).width;
                        if ((G.valueAxis[R] & 1) == 1) {
                            U = 0
                        } else {
                            if (U > 0) {
                                G.valueAxis[R] |= 1
                ...
                if (T != "left" && o.rtl == true) {
                    T = "right"
                }
                if (T != "right") {
                    T = "left"
                }
                if (u[T + "Count"] > 0 && u[T] > 0 && U > 0) {
                    u[T] += Z
                }
                r.push({
                    width: U,
            ...
            var A = Math.max(1, Math.max(F.width, F.height));
            var ah = {
                top: 0,
                bottom: 0,
                topCount: 0,
            ...
            for (ae = 0; ae < v.length; ae++) {
                ...
                H = ai.orientation == "horizontal";
                var m = this._getValueAxis(ae);
                var R = m == o._getValueAxis() ? -1 : ae;
                var C = o._getXAxis(ae);
                var aj = C == o._getXAxis() ? -1 : ae;
                var ag = !H ? C.axisSize : m.axisSize;
                var T = H ? m.position : C.position;
                if (!ag || ag == "auto") {
                    if (H) {
                        ag = o._renderValueAxis(ae, {
                            x: 0,
                            y: 0,
                            width: A,
                            height: 0
                        }, true, b).height;
                        if ((G.valueAxis[R] & 2) == 2) {
                            ag = 0
                        } else {
                            if (ag > 0) {
                                G.valueAxis[R] |= 2
            ...
            o._createAnimationGroup("series");
            var z = (o.showLegend != false);
            var E = !z ? {
                width: 0,
                height: 0
            } : o._renderLegend(o.legendLayout ? o._rect : aa, true);
            ...
            if (aa.height < ah.top + ah.bottom + E.height || aa.width < u.left + u.right) {
                L.endGroup();
                return
            }
            b.height -= ah.top + ah.bottom + E.height;
            b.x += u.left;
            b.width -= u.left + u.right;
            b.y += ah.top;
            var J = [];
            if (!K) {
                var ak = o._getXAxis().tickMarksColor || o._defaultLineColor;
                for (ae = 0; ae < v.length; ae++) {
                    var ai = v[ae];
                    if (ai.polar == true || ai.spider == true || ai.type == "pie" || ai.type == "donut") {
                        continue
                    }
                    H = ai.orientation == "horizontal";
                    var aj = o._getXAxis(ae) == o._getXAxis() ? -1 : ae;
                    var R = o._getValueAxis(ae) == o._getValueAxis() ? -1 : ae;
                    var k = {
                        x: b.x,
                        y: 0,
                        width: b.width,
                    ...
                    if (ab[ae].position != "top") {
                        k.y = b.y + b.height + ab[ae].yRel
                    } else {
                        k.y = b.y - ab[ae].yRel - ab[ae].height
                    } if (H) {
                        if ((G.valueAxis[R] & 4) == 4) {
                            continue
                        }
                        if (!o._isGroupVisible(ae)) {
                            continue
                        }
                        o._renderValueAxis(ae, k, false, b);
                        G.valueAxis[R] |= 4
                    } else {
                        J.push(k);
                        if ((G.xAxis[aj] & 4) == 4) {
                        ...
                        o._renderXAxis(ae, k, false, b);
                        G.xAxis[aj] |= 4
                    }
                }
            }
            if (z) {
                var D = o.legendLayout ? o._rect : aa;
                var S = aa.x + a.jqx._ptrnd((aa.width - E.width) / 2);
                var Q = b.y + b.height + ah.bottom;
                var U = aa.width;
                var ag = E.height;
                if (o.legendLayout) {
                    if (!isNaN(o.legendLayout.left)) {
                        S = o.legendLayout.left
                    }
                    if (!isNaN(o.legendLayout.top)) {
                        Q = o.legendLayout.top
                    }
                    if (!isNaN(o.legendLayout.width)) {
                        U = o.legendLayout.width
                    }
                    if (!isNaN(o.legendLayout.height)) {
                        ag = o.legendLayout.height
                    }
                }
                if (S + U > D.x + D.width) {
                    U = D.x + D.width - S
                }
                if (Q + ag > D.y + D.height) {
                    ag = D.y + D.height - Q
                }
                o._renderLegend({
                    x: S,
            ...
            if (!K) {
                for (ae = 0; ae < v.length; ae++) {
                    ...
                    H = v[ae].orientation == "horizontal";
                    var k = {
                        x: b.x - r[ae].xRel - r[ae].width,
                        y: b.y,
                        width: r[ae].width,
                        height: b.height
                    };
                    if (r[ae].position != "left") {
                        k.x = b.x + b.width + r[ae].xRel
                    }
                    var aj = o._getXAxis(ae) == o._getXAxis() ? -1 : ae;
                    var R = o._getValueAxis(ae) == o._getValueAxis() ? -1 : ae;
                    if (H) {
            ...
            for (ae = 0; ae < v.length; ae++) {
                this._drawPlotAreaLines(ae, true, {
                    gridLines: false,
                    tickMarks: false,
                    alternatingBackground: true
                });
                this._drawPlotAreaLines(ae, false, {
                    gridLines: false,
                    tickMarks: false,
                    alternatingBackground: true
                })
            ...
            var N = false;
            for (ae = 0; ae < v.length && !N; ae++) {
                var ai = v[ae];
                if (ai.annotations !== undefined || a.isFunction(ai.draw) || a.isFunction(ai.drawBefore)) {
                    N = true;
                    break
                }
            }
            ...
            for (ae = 0; ae < v.length; ae++) {
                var ai = v[ae];
                var d = false;
                for (var al in o._seriesTypes) {
                    if (o._seriesTypes[al] == ai.type) {
                        d = true;
                        break
                    }
                }
                if (!d) {
                    throw 'Invalid serie type "' + ai.type + '"'
                }
                if (a.isFunction(ai.drawBefore)) {
                    ai.drawBefore(L, F, ae, this)
                }
                if (ai.polar == true || ai.spider == true) {
                    if (ai.type.indexOf("pie") == -1 && ai.type.indexOf("donut") == -1) {
                        o._renderSpiderAxis(ae, b)
                    }
                }
                o._renderAxisBands(ae, b, true);
                o._renderAxisBands(ae, b, false)
            }
            for (ae = 0; ae < v.length; ae++) {
                var ai = v[ae];
                if (o._isColumnType(ai.type)) {
                    o._renderColumnSeries(ae, b)
                } else {
                    if (ai.type.indexOf("pie") != -1 || ai.type.indexOf("donut") != -1) {
                        o._renderPieSeries(ae, b)
                    } else {
                        if (ai.type.indexOf("line") != -1 || ai.type.indexOf("area") != -1) {
                            o._renderLineSeries(ae, b)
                        } else {
                            if (ai.type.indexOf("scatter") != -1 || ai.type.indexOf("bubble") != -1) {
                                o._renderScatterSeries(ae, b)
                            } else {
                                if (ai.type.indexOf("candlestick") != -1 || ai.type.indexOf("ohlc") != -1) {
                                    o._renderCandleStickSeries(ae, b, ai.type.indexOf("ohlc") != -1)
                                }
                            }
                        }
                    }
                    ...
                    for (var ac = 0; ac < ai.annotations.length; ac++) {
                        o._renderAnnotation(ae, ai.annotations[ac], b)
                    }
                }
                if (a.isFunction(ai.draw)) {
                    o.draw(L, F, ae, this)
                }
            }
            L.endGroup();
            if (o.enabled == false) {
                var af = L.rect(F.x, F.y, F.width, F.height);
                L.attr(af, {
                    fill: "#777777",
                    opacity: 0.5,
                    stroke: "#00FFFFFF"
            ...
            if (a.isFunction(o.draw)) {
                o.draw(L, F)
            }
            L.endGroup();
            o._startAnimation("series");
            var X = String.fromCharCode(119, 119, 119, 46, 106, 113, 119, 105, 100, 103, 101, 116, 115, 46, 99, 111, 109);
            if (!o._isRangeSelectorInstance && location.hostname.indexOf(X.substring(4)) == -1) {
                var c = {
                    "class": o.toThemeProperty("jqx-chart-legend-text", null),
                    opacity: 0
                };
                var V = L.measureText(X, 0, c);
                var l = L.text(X, F.x + F.width - V.width - 5, F.y + F.height - V.height - 5, V.width, V.height, 0, c);
                a(l).on("click", function () {
                    // location.href = "http://" + X + "/?ref=" + o.widgetName
                })
            }
            var am = false;
            for (var ae = 0; ae < o.seriesGroups.length && !am; ae++) {
                var C = o._getXAxis(ae);
                if (C && C.rangeSelector) {
                    am = true
                }
            }
            if (am) {
                ...
                if (!this._isSelectorRefresh) {
                    o.removeHandler(a(document), o._getEvent("mousemove"), o._onSliderMouseMove);
                    o.removeHandler(a(document), o._getEvent("mousedown"), o._onSliderMouseDown);
                    o.removeHandler(a(document), o._getEvent("mouseup"), o._onSliderMouseUp)
                }
                if (!o._isSelectorRefresh) {
                    o._rangeSelectorInstances = {}
                }
                for (ae = 0; ae < o.seriesGroups.length; ae++) {
                    var B = this._getXAxis(ae);
                    if (e.indexOf(B) == -1) {
                        if (this._renderXAxisRangeSelector(ae, J[ae])) {
                            e.push(B)
                        }
                    }
                }
